...
### router.add(name, pathExpression, controller, view, [options]) ⇒ [<code>Router</code>](#Router)
...
### router.remove(name) ⇒ [<code>Router</code>](#Router)
...
<a name="Router+getUrl"></a>

### router.getUrl() ⇒ <code>string</code>
...
<a name="Router+getBaseUrl"></a>

### router.getBaseUrl() ⇒ <code>string</code>
...
<a name="Router+getDomain"></a>

### router.getDomain() ⇒ <code>string</code>
...
<a name="Router+getHost"></a>

### router.getHost() ⇒ <code>string</code>
...
<a name="Router+getProtocol"></a>

### router.getProtocol() ⇒ <code>string</code>
...
<a name="Router+getCurrentRouteInfo"></a>

### router.getCurrentRouteInfo() ⇒ <code>Object</code>
...
### router.listen() ⇒ [<code>Router</code>](#Router)
...
<a name="Router+link"></a>

### router.link(routeName, params) ⇒ <code>string</code>
...
### router.route(path, [options]) ⇒ <code>Promise.&lt;Object.&lt;string, \*&gt;&gt;</code>
...
### router.handleError(params, [options]) ⇒ <code>Promise.&lt;Object.&lt;string, \*&gt;&gt;</code>
...
<a name="Router+handleNotFound"></a>

### router.handleNotFound(params, [options]) ⇒ <code>Promise.&lt;Object.&lt;string, \*&gt;&gt;</code>
...
<a name="Router+isClientError"></a>

### router.isClientError(reason) ⇒ <code>boolean</code>
...
<a name="Router+isRedirection"></a>

### router.isRedirection(reason) ⇒ <code>boolean</code>
