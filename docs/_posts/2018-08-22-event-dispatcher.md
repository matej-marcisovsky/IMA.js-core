...
<a name="Dispatcher+clear"></a>

### dispatcher.clear() ⇒ [<code>Dispatcher</code>](#Dispatcher)
...
<a name="Dispatcher+listen"></a>

### dispatcher.listen(event, listener, [scope]) ⇒ [<code>Dispatcher</code>](#Dispatcher)
...
<a name="Dispatcher+unlisten"></a>

### dispatcher.unlisten(event, listener, [scope]) ⇒ [<code>Dispatcher</code>](#Dispatcher)
...
<a name="Dispatcher+fire"></a>

### dispatcher.fire(event, data, [imaInternalEvent]) ⇒ [<code>Dispatcher</code>](#Dispatcher)
