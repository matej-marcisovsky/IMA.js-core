...
<a name="PageRenderer+mount"></a>

### pageRenderer.mount(controller, view, pageResources, routeOptions) ⇒ <code>Promise.&lt;{status: number, content: ?string, pageState: Object.&lt;string, ?&gt;}&gt;</code>
...
<a name="PageRenderer+update"></a>

### pageRenderer.update(controller, resourcesUpdate) ⇒ <code>Promise.&lt;{status: number, content: ?string, pageState: Object.&lt;string, \*&gt;}&gt;</code>
...
<a name="PageRenderer+setState"></a>
...
<a name="PageRenderer+clearState"></a>
