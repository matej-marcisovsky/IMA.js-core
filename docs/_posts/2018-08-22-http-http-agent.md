...
<a name="HttpAgent+get"></a>

### httpAgent.get(url, data, [options]) ⇒ [<code>Promise.&lt;Response&gt;</code>](#HttpAgent..Response)
...
<a name="HttpAgent+post"></a>

### httpAgent.post(url, data, [options]) ⇒ [<code>Promise.&lt;Response&gt;</code>](#HttpAgent..Response)
...
<a name="HttpAgent+put"></a>

### httpAgent.put(url, data, [options]) ⇒ [<code>Promise.&lt;Response&gt;</code>](#HttpAgent..Response)
...
<a name="HttpAgent+patch"></a>

### httpAgent.patch(url, data, [options]) ⇒ [<code>Promise.&lt;Response&gt;</code>](#HttpAgent..Response)
...
<a name="HttpAgent+delete"></a>

### httpAgent.delete(url, data, [options]) ⇒ [<code>Promise.&lt;Response&gt;</code>](#HttpAgent..Response)
...
<a name="HttpAgent+getCacheKey"></a>

### httpAgent.getCacheKey(method, url, data) ⇒ <code>string</code>
...
<a name="HttpAgent+setDefaultHeader"></a>

### httpAgent.setDefaultHeader(header, value) ⇒ [<code>HttpAgent</code>](#HttpAgent)
...
<a name="HttpAgent+clearDefaultHeaders"></a>

### httpAgent.clearDefaultHeaders() ⇒ [<code>HttpAgent</code>](#HttpAgent)
...
<a name="HttpAgent..RequestOptions"></a>

### HttpAgent~RequestOptions : <code>Object</code>
...
<a name="HttpAgent..Response"></a>

### HttpAgent~Response : <code>Object</code>
